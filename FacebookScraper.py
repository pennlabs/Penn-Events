...
# page = requests.get('https://www.facebook.com/events/2842763029277309?acontext=%7B%22event_action_history%22%3A[%7B%22mechanism%22%3A%22discovery_top_tab%22%2C%22surface%22%3A%22bookmark%22%7D]%7D')
...
# elements = soup.find_all('div', class_='hidden_elem')
